...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
   def mostRetweetedHelper(Tweet1: Tweet, Tweet2: Tweet): Tweet = {
     if (Tweet1.retweets > Tweet2.retweets) Tweet1 else Tweet2
   }
    if (left.isEmpty && right.isEmpty) elem
    else if (right.isEmpty) mostRetweetedHelper(left.mostRetweeted,elem)
    else if (left.isEmpty) mostRetweetedHelper(right.mostRetweeted,elem)
    else mostRetweetedHelper(left.mostRetweeted,mostRetweetedHelper(left.mostRetweeted,elem))
  }
